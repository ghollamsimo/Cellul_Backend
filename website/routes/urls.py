...
urlpatterns = [
    ...
    path('reset-password/<str:token>/', AuthView.as_view(), {'action': 'reset_password'}, name='reset-password'),
    path('count/<int:id>', stats),
    ...
    path('handle_feedback/<str:action>/<int:pk>', FeedbackView.as_view()),
    ...
    path('record/<str:action>/<int:pk>', RecordView.as_view()),
